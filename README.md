...
La barre d'outils permet d'afficher ou masquer les années, trimestres, mois, semaines et jours. Ils s'affichent toujours dans cet ordre. Les menus « Quadrillage vertical principal » et « Quadrillage vertical secondaire » ne proposent que les frises visibles et déterminent leur périodicité : activez « Jours » pour pouvoir afficher un quadrillage quotidien. Le secondaire est désactivé par défaut. Dans « Langue des libellés », choisissez le français ou l’anglais : les mois, trimestres et semaines s’adaptent (par exemple `T1` / `S32` en français et `Q1` / `W32` en anglais).
...
Le bouton **Thème** propose des palettes prêtes à l’emploi et un panneau séparant clairement le **Nuancier**, le **Quadrillage vertical**, la **Frise temporelle** et les **Lignes et flèches**. Les quadrillages principal et secondaire disposent chacun de leur couleur, épaisseur et type de ligne ; le secondaire est fin et pointillé par défaut. Dans la section Frise temporelle, sélectionnez les années, trimestres, mois, semaines ou jours pour modifier leurs deux couleurs, leur hauteur et leur taille de police sans afficher les réglages de tous les niveaux à la fois. Utilisez la même couleur principale et alternée pour ne pas créer d’alternance. Le nuancier est organisé par rôle : couleurs principale et secondaire (chacune avec ses trois nuances), accent, texte principal/secondaire/sur fond sombre, gris neutres, fonds, bordure/quadrillage, puis états (alerte, attention, succès). Le thème fait partie des données du planning : il est donc conservé par l’enregistrement local et par les exports JSON.
