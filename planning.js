...
function normalise(data) {
  ...
  data.lanes.forEach(lane => { lane.items ||= []; lane.milestones ||= []; lane.milestones.forEach(normaliseMilestone); });
  ids(data);
  return data;
}
