...
const THEME_APPEARANCE_OPTIONS = [["timelineYear", "Frise — années"], ["timelineYearAlternate", "Frise — années alternées"], ["timelineQuarter", "Frise — trimestres"], ["timelineQuarterAlternate", "Frise — trimestres alternés"], ["timelineMonth", "Frise — mois"], ["timelineMonthAlternate", "Frise — mois alternés"], ["timelineWeek", "Frise — semaines"], ["timelineWeekAlternate", "Frise — semaines alternées"], ["timelineDay", "Frise — jours"], ["timelineDayAlternate", "Frise — jours alternés"], ["todayLine", "Ligne d’aujourd’hui"], ["dependencyIncoming", "Dépendance entrante"], ["dependencyOutgoing", "Dépendance sortante"], ["dependencyNeutral", "Dépendance neutre"]];
...
const timelineLevels = [
  ...
  { key: "day", toggle: document.getElementById("toggleDayTimeline"), h: 20, fillRole: "timelineDay", altRole: "timelineDayAlternate", cls: "day-label" }
];
...
function emptyPlanning() {
  ...
  return {
    ...
    layout: { width: 1500, left: 86, right: 16, topMonths: 8, monthHeight: 40, dayHeight: 20, timelineTop: 58, lanesTop: 160, laneGap: 5, lanePaddingBottom: 10, defaultItemHeight: 30 },
