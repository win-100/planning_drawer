...
const THEME_PRESETS = {
  ocean: { name: "Océan", colors: { primary: "#22a79f", primaryStrong: "#147b75", primarySoft: "#c8ece9", accent: "#e8ad72", accentSoft: "#f4cfad", text: "#101820", textSecondary: "#5f6b72", neutral: "#8c9397", neutralSoft: "#e9edef", surface: "#ffffff", surfaceAlt: "#f7fafa", border: "#cbd4d6", danger: "#ef2d20", warning: "#c96a12", success: "#168f88" } },
  indigo: { name: "Indigo", colors: { primary: "#6366f1", primaryStrong: "#4338ca", primarySoft: "#e0e7ff", accent: "#db2777", accentSoft: "#fce7f3", text: "#172033", textSecondary: "#526174", neutral: "#94a3b8", neutralSoft: "#e8edf4", surface: "#ffffff", surfaceAlt: "#f8faff", border: "#cbd5e1", danger: "#dc2626", warning: "#b7791f", success: "#16845b" } },
  forest: { name: "Forêt", colors: { primary: "#2f855a", primaryStrong: "#166534", primarySoft: "#dcfce7", accent: "#ca8a04", accentSoft: "#fef3c7", text: "#17221a", textSecondary: "#52635a", neutral: "#94a3a0", neutralSoft: "#eaf0eb", surface: "#ffffff", surfaceAlt: "#f8fcf8", border: "#cbd8ce", danger: "#dc2626", warning: "#b7791f", success: "#16845b" } },
  sunset: { name: "Coucher de soleil", colors: { primary: "#ea580c", primaryStrong: "#c2410c", primarySoft: "#ffedd5", accent: "#be185d", accentSoft: "#fce7f3", text: "#2b1b14", textSecondary: "#6f625b", neutral: "#a8a29e", neutralSoft: "#f1efed", surface: "#fffdf9", surfaceAlt: "#fff8f1", border: "#ded3ca", danger: "#dc2626", warning: "#b7791f", success: "#16845b" } }
};
// Roles are semantic: the palette covers content, neutral UI and status
// colours without prescribing where each one is used.
const THEME_COLOR_OPTIONS = [["primary", "Principale"], ["primaryStrong", "Principale — foncée"], ["primarySoft", "Principale — claire"], ["accent", "Accent"], ["accentSoft", "Accent — clair"], ["text", "Texte principal"], ["textSecondary", "Texte secondaire"], ["neutral", "Gris neutre"], ["neutralSoft", "Gris neutre — clair"], ["surface", "Fond principal"], ["surfaceAlt", "Fond alternatif"], ["border", "Bordure / quadrillage"], ["danger", "Alerte / échéance critique"], ["warning", "Attention"], ["success", "Succès / validation"]];
const THEME_COLOR_GROUPS = [["Identité", ["primary", "primaryStrong", "primarySoft"]], ["Accent", ["accent", "accentSoft"]], ["Texte", ["text", "textSecondary"]], ["Neutres", ["neutral", "neutralSoft", "border"]], ["Fonds", ["surface", "surfaceAlt"]], ["États", ["danger", "warning", "success"]]];
