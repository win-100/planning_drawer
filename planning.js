...
function drawDateDependencies() {
  const defs = el("defs"), marker = el("marker", { id: "date-dependency-arrow", viewBox: "0 0 7 7", refX: 6.2, refY: 3.5, markerWidth: 5, markerHeight: 5, orient: "auto-start-reverse" });
  marker.appendChild(el("path", { d: "M 0 0 L 7 3.5 L 0 7 z", fill: "#52666d" })); defs.appendChild(marker); svg.appendChild(defs);
